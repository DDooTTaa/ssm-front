...
//가 (끝에 받침 없음)
const underRandomWord = ['의자','감자', '커피', '버스', '담배', '나무', '비', '해', '대파', '소화기', '배', '경고', '위기', '진달래', '사이', '비행기', '강아지', '고양이'];
//이 (끝에 받침 있음)
const upperRandomWord = ['달','책상', '섬', '꽃', '커튼', '선인장', '벚꽃', '칼', '별', '결혼', '꿀', '총', '병', '가을', '간', '연인', '인연', '끝', '그림', '봄', '횃불', '산책'];

function App() {
  const appTitle = '영감을 주는 문장 만들기';
